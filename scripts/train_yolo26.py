...
사용법:
    python scripts/train_yolo26.py -c config/train_yolo26.yaml
    python scripts/train_yolo26.py -c config/train_yolo26.yaml --mode tune
"""
...
def main():
    ...
    parser.add_argument("-c", "--config", default="config/train_yolo26.yaml",
