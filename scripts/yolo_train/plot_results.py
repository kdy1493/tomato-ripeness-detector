...
Usage:
  python scripts/yolo_train/plot_results.py --csv runs/yolo26_custom_tomato/results.csv
  python scripts/yolo_train/plot_results.py --csv runs/yolo26_custom_tomato/results.csv --out runs/yolo26_custom_tomato/metrics.png
"""
...
def plot_results(csv_path: str, out_path: str | None = None) -> None:
    ...
    ax.annotate(
        f"best: {best_map:.4f} (ep {int(df.loc[best_epoch, 'epoch'])})",
